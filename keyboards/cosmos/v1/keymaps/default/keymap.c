...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
      ...
      OS_LSFT,    KC_A,    KC_R,    KC_S,      KC_T,    KC_G,                         KC_M,    KC_N,    KC_E,     KC_I,    KC_O,      OS_LSFT,
      OS_LCTL,    KC_Z,    KC_X,    KC_C,      KC_D,    KC_V,                         KC_K,    KC_H,    KC_COMM,  KC_DOT,  KC_SLSH,   OS_LCTL,
                           C_COPY, C_PASTE,                                                           C_UNDO,  C_REDO, 
                                               S(KC_MINUS), NAV_SPC,  SYN_ENT,  NAV_DEL,  SYN_BSPC,  OS_FUN,
                                                         ALT_ESC, C_LEAD,   QK_LLCK,   CW_TOGG
  ),

    [_QWERTY] = LAYOUT(
      KC_ESC,  KC_1,  KC_2,       KC_3,    KC_4,    KC_5,                          KC_6,    KC_7,    KC_8,     KC_9,    KC_0,      KC_LGUI,
      KC_TAB,    KC_Q,  KC_W,       KC_E,    KC_R,    KC_T,                          KC_Y,    KC_U,    KC_I,     KC_O,    KC_P,      QK_REP,
      OS_LSFT,   KC_A,  KC_S,       KC_D,    KC_F,    KC_G,                          KC_H,    KC_J,    KC_K,     KC_L,    KC_QUOT,   OS_LSFT,
    ...
    [_NAV] = LAYOUT(
      ...
      _______, C_UNDO,    C_CUT,    C_COPY,   C_PASTE,   C_REDO,                      KC_COMMA,        KC_1,     KC_2,       KC_3,     XXXXXXX,      KC_EQUAL,
